...
const cancelFileUpload = document.getElementById("file-cancel");
const chatbotToggler = document.getElementById("chatbot-toggler");
const closeChatbot = document.getElementById("close-chatbot");

// APIS setup
const API_KEY = "AIzaSyAQrbkKN9LMK_TRiv8VayCZr_5EleEpGIc";
...
const handleOutgoingMessage = (e) => {
    ...
    // Make The Message To Dissapear wHEN Enter KEY Is Clicked
    messageInput.value = "";
